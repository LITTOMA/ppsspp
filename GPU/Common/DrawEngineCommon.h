...
public:
	...
	int ExtendNonIndexedPrim(const u32_le *cmd, const u32_le *stall, const VertexDecoder *dec, u32 vertTypeID, bool clockwise, int *bytesRead, bool isTriangle, ClipInfoFlags clipInfoFlags);
